  ...
  <div class="container">
    <div class="row">
        ...
        <form class="col-md-4 col-md-offset-4">
         ...
         <button type="submit" class="btn btn-default col-md-12"> Ajouter aux article en ligne </button><br><br>
         <button type="submit" class="btn btn-default col-md-12"> Ajouter aux brouillons </button><br><br>
         <button type="submit" class="btn btn-default col-md-12"> Retour </button><br><br>
